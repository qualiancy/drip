...
Drip.prototype.on = function (ev, fn) {
  ...
  if (!this._drip || (this._drip && !this._drip.wildcards)) {
  ...
  } else if (this._drip && this._drip.wildcards) {
...
Drip.prototype.off = function (ev, fn) {
  ...
  if ('function' !== typeof fn) return this.removeAllListeners(ev);
  ...
  if (!this._drip || (this._drip && !this._drip.wildcards)) {
    ...
    if (!fns) {
      ...
      if (fns.length == 1) this._events[ev] = fns[0];
    }
  } else {
